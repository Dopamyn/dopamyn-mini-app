...
export const useEthereumQuestManager = () => {
  const chainConfig = getChainConfig("ethereum-mainnet");
  ...
  const showNotImplementedToast = () => {
    toast({
      title: "Ethereum Support Coming Soon",
      description: "Ethereum quest creation is not yet available. Please use Base or Solana for now.",
      variant: "destructive",
    });
  };
  ...
  const approveTokens = async (
    ...
    throw new Error("Ethereum quest manager not implemented yet");
  };
